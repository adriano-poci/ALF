#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Thu 16 Oct 14:58:48 BST 2025      
date_start=`date +%s`
...
export OMP_NUM_THREADS=21
 nice -n 10 /bin/bash -lc module purge || true; module load gcc/13.2; module load openmpi; module load python/3.11.4; export ALF_HOME=/mnt/extraspace/poci/alf/; export PSM2_CUDA=0; export PMIX_MCA_gds=hash; cd /mnt/extraspace/poci/alf/; mpirun --bind-to core --map-by core ./NGC3630/bin/alf.exe NGC3630_SN100_0002 2>&1 | tee -a NGC3630/out_0002.log
  echo ---------------                                           
