...
#SBATCH -A durham
#SBATCH -p cosma
#SBATCH --job-name="alf_SNL1_WFM_1arcs"
#SBATCH --time=0-48:00
#SBATCH --ntasks=1
#SBATCH -N 1
...
#SBATCH -e SNL1_WFM_error.log # Standard err to galaxy
...
cd ${ALF_HOME}
# Run aperture fit
mpirun --oversubscribe -np ${SLURM_CPUS_PER_TASK} ./bin/alf.exe "SNL1_WFM_1arcs" 2>&1 | tee -a "SNL1/out_1arcs.log"
